  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(0,0,0,.20), rgba(0,0,0,.45), rgba(0,0,0,.75))",
        }}
      />
      ...
      <div className="relative z-10 flex max-w-5xl flex-col items-center px-6 text-center">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <button className="rounded-full bg-white px-8 py-4 font-semibold text-[#6b1b9a] transition-all duration-300 hover:-translate-y-1 hover:scale-105">
            Join Us
          </button>

          <button className="rounded-full border border-white/30 bg-white/10 px-8 py-4 font-semibold text-white backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-white/20">
            Watch Sermons
          </button>
        </div>
      </div>
